...
#include <iostream>
#include <iomanip>
#include "LAM_perf_collector_chrono.h"
...
lam::system
::PerfCollectorChrono
::PerfCollectorChrono(_In_ const PerfCollectorChrono &x)
:
...
lam::system
::PerfCollectorChrono
::PerfCollectorChrono(_In_ PerfCollectorChrono &&x)
:
m_Iscleared{ x.m_Iscleared },
m_nsamples{ x.m_nsamples },
...
lam::system::PerfCollectorChrono &
lam::system::PerfCollectorChrono
::operator=(_In_ const PerfCollectorChrono &x){
...
lam::system::PerfCollectorChrono &
lam::system::PerfCollectorChrono
::operator=(_In_ PerfCollectorChrono &&x) {
	if (this == &x) return (*this);
			m_Iscleared = x.m_Iscleared;
			m_nsamples = x.m_nsamples;
...
lam::system
::PerfCollectorChrono
::correlation_set(_In_ PerfCollectorChrono &set1,
				  _In_ PerfCollectorChrono &set2,
