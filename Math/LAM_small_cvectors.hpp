...
#ifndef __LAM_SMALL_CVECTORS_HPP__
#define __LAM_SMALL_CVECTORS_HPP__
	...
	namespace math {
		...
		*/
		template<typename Real_t, uint64_t N> struct CVecAdd1 {
			  ...
			  std::enable_if<std::
			  is_pointer<Real_t>::value,void>
			  operator()(_Inout_ Real_t* __restrict oRe,
					     _Inout_ Real_t* __restrict oIm,
						 _In_ const Real_t* __restrict iRe1,
						 _In_ const Real_t* __restrict iIm1,
						 _In_ const Real_t* __restrict iRe2,
						 _In_ const Real_t* __restrict iIm2) {
		...
		*/
		template<typename Real_t> struct CVecSub2<Real_t, 0ULL>{
			...
			is_pointer<Real_t>::value,void>
			operator()(_Inout_ Real_t* __restrict oRe,
					   _In_ const Real_t* __restrict oRe1,
			           _In_ const Real_t* __restrict oRe2) {
		...
		*/
		template<typename Real_t, uint64_t N> struct CVecMul2{
			...
			operator()(_Inout_ Real_t* __restrict oRe,
					   _Inout_ Real_t* __restrict oIm,
					   _In_ const Real_t* __restrict iRe,
					   _In_ const Real_t* __restrict iIm,
					   _In_ const Real_t* __restrict v) {
		...
		*/
		template<typename Real_t, unt64_t N> struct CVecDiv2{
		...
		*/
		...
		template<typename uint64_t N> struct AVXCVecAdd{
			...
			void operator()(_Inout_ double* __restrict oRe,
						    _Inout_ double* __restrict oIm,
						    _In_ const double* __restrict iRe1,
				            _In_ const double* __restrict iRe2,
				            _In_ const double* __restrict iIm1,
				            _In_ const double* __restrict iIm2) {
		...
		*/
		...
		template<uint64_t N> struct AVXCVecAdd2{
			...
			void operator()(_Inout_ double* __restrict oRe,
							_In_ const double* __restrict oRe1,
							_In_ const double* __restrict oRe2) {
		...
		*/
		...
		template<uint64_t N> struct AVXCVecSub2{
			...
			static_assert((N % 4ULL) == 0, "N % 4 != 0");
			void operator()(_Inout_ double* __restrict oRe,
						    _Inout_ double* __restrict iRe1,
							_Inout_ double* __restrict iRe2) {
		...
		*/
		...
		template<uint64_t N> struct AVXCVecMul2{
			...
			void operator()(_Inout_ double* __restrict oRe,
							_Inout_ double* __restrict oIm,
							_In_ const double* __restrict iRe,
							_In_ const double* __restrict iIm,
							_In_ const double* __restrict v) {
...
#endif /*__LAM_SMALL_CVECTORS_HPP__*/