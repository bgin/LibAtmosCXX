...
#if (USE_AVX3COMPLEX_NT_STORES) == 1
		avx256_memcpy8x_nt(&data.m_Re[0], &x.data.m_Re[0], x.data.m_nsize);
		avx256_memcpy8x_nt(&data.m_Im[0], &x.data.m_Im[0], x.data.m_nsize);
#else
		avx256_memcpy8x(&data.m_Re[0], &x.data.m_Re[0], x.data.m_nsize);
		avx256_memcpy8x(&data.m_Im[0], &x.data.m_Im[0], x.data.m_nsize);
#endif
   }
