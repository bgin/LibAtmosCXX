...
const unsigned int gLAM_GTC64_TIMER_MAJOR = 1U;

const unsigned int gLAM_GTC64_TIMER_MINOR = 0U;

const unsigned int gLAM_GTC64_TIMER_MICRO = 0U;

const unsigned int gLAM_GTC64_TIMER_FULLVER = 
		1000U*gLAM_GTC64_TIMER_MAJOR + 100U*gLAM_GTC64_TIMER_MINOR + 10U*gLAM_GTC64_TIMER_MICRO;

const char * const pgLAM_GTC64_TIMER_CREATE_DATE = "26-08-2018 11:07 +00200 (SUN 26 AUG 2018 GMT+2) ";

const char * const pgLAM_GTC64_TIMER_BUILD_DATE = "00-00-0000 00:00 ";

const char * const pgLAM_GTC64_TIMER_AUTHOR = "Programmer: Bernard Gingold, contact: beniekg@gmail.com";

const char * const pGLAM_GTC64_TIMER_SYNOPSIS = "GetTickCount64 timer benchmarking based class.";
