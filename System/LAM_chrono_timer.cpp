...
lam::system
::HRCTimer
::HRCTimer(_In_ const std::size_t nruns,
...
lam::system
::HRCTimer
::HRCTimer(_In_ const HRCTimer &x)
:
m_nruns{ x.m_nruns },
...
lam::system::HRCTimer &
lam::system::HRCTimer
::operator=(_In_ const HRCTimer &x) {
...
::delta_values_eq(_Out_ std::vector<bool> &vres,
				  _In_  const HRCTimer &set1,
				  _In_  const HRCTimer &set2,
