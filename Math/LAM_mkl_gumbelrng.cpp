...
lam::math::stat::
MKLGumbelRNG::
MKLGumbelRNG(_In_ const MKL_INT nvalues,
...
lam::math::stat::
MKLGumbelRNG::
MKLGumbelRNG(_In_ const MKLGumbelRNG &x)
:
...
lam::math::stat::
MKLGumbelRNG::
MKLGumbelRNG(_In_ MKLGumbelRNG &&x)
:
m_nvalues{ x.m_nvalues },
m_brng{ x.m_brng },
m_seed{ x.m_seed },
...
lam::math::stat::MKLGumbelRNG &
lam::math::stat::MKLGumbelRNG::
operator=(_In_ const MKLGumbelRNG &x) {
