...
#if !defined (LAM_GTC64_TIMER_CHECK_ARGS_CONFORMANCE)
#define LAM_GTC64_TIMER_CHECK_ARGS_CONFORMANCE(vres,set1,set2)	                    \
		do{														                    \
...
::delta_values_eq(_Out_ std::vector<bool> &vres,
	...
	LAM_GTC64_TIMER_CHECK_ARGS_CONFORMANCE(vres, set1, set2)
