...
#include <iostream>
#include <iomanip>
#include "LAM_perf_collector_rdtscp.h"
...
lam::system
::PerfCollectorRDTSCP::
PerfCollectorRDTSCP(_In_ const PerfCollectorRDTSCP &x)
:
...
lam::system::PerfCollectorRDTSCP
::PerfCollectorRDTSCP(_In_ PerfCollectorRDTSCP &&x)
:
...
lam::system::PerfCollectorRDTSCP &
lam::system::PerfCollectorRDTSCP
::operator=(_In_ const PerfCollectorRDTSCP &x) {
...
lam::system::PerfCollectorRDTSCP &
lam::system::PerfCollectorRDTSCP
::operator=(_In_ PerfCollectorRDTSCP &&x){
	if (this == &x) return (*this);
	    m_Iscleared = std::move(x.m_Iscleared);
	    m_nsamples  = std::move(x.m_nsamples);
...
lam::system
::PerfCollectorRDTSCP
::correlation_set(_In_ PerfCollectorRDTSCP &set1,
				  _In_ PerfCollectorRDTSCP &set2,
	...
	aligned_r8ptr dataset1 = lam::common::lam_edmalloca(set_size,align64B);
	aligned_r8ptr dataset2 = lam::common::lam_edmalloca(set_size,align64B);
#if (USE_ACCURATE_IEEE754_2008_FP) == 1
...
bool 
lam::system::PerfCollectorRDTSCP
::cvrt_to_double(_Out_ double * __restrict data,
