...
!DIR$     ATTRIBUTES ALIGN : 64 :: tbar0
          ...
          type ArgsR64
               ...
               !DIR$ ATTRIBUTES ALIGN : 64 :: k,pih,twopi,pione,gcs,gcv,eps, 
               !DIR$ ATTRIBUTES ALIGN : 64 :: fint,temp,temp0,x0,y0,z0,gcsr
               !DIR$ ATTRIBUTES ALIGN : 64 :: gcvr,xv,xs,ratio,RAT,DDELT,alph
               !DIR$ ATTRIBUTES ALIGN : 64 :: beta s,t,ca,sa
               !DIR$ ATTRIBUTES ALIGN : 64 :: sb,cb,xd,d,cz,cext0,cext1,fuv1,fuv2
               !DIR$ ATTRIBUTES ALIGN : 64 :: fuv3,guv,guv3,guv5,guv4,guv6,rn,rm
               !DIR$ ATTRIBUTES ALIGN : 64 :: p,fnp,fn,gmn,gmn1,gmn2,gmn3,gmn5
               !DIR$ ATTRIBUTES ALIGN : 64 ::  gmn4,cwmf1,theta,gn,cbak,lnfacd,gmnj
               !DIR$ ATTRIBUTES ALIGN : 64 :: guv1,guv2,xt
          ...
          type ArgsI32
             ...
             !DIR$ ATTRIBUTES ALIGN : 64 ::  i,j1,j2,n,in0,iv0,m,imn,iuv,imn1
             !DIR$ ATTRIBUTES ALIGN : 64 ::  iuv1,nmax0,imax,n0,ii,ij,iv,inn,n1          !! in original code was: in, here it was changed to: inn
             !DIR$ ATTRIBUTES ALIGN : 64 ::  ip,iq,is,isn,isv,nlarge,nbes,irc      
             !DIR$ ATTRIBUTES ALIGN : 64 ::  itrc,iuvc,niter,ijmax,ijmin,iuvp        
             !DIR$ ATTRIBUTES ALIGN : 64 ::  jv1,iuv2,iuv3,juv1,juv2,juv3,juv4       
             !DIR$ ATTRIBUTES ALIGN : 64 ::  juv5,juv6,ntemp,n2,imn2,imn3,jmn1,jmn2
             !DIR$ ATTRIBUTES ALIGN : 64 ::  jmn3,jmn4,jmn5,jmn6,nmax2,it,ii,nmf1
             !DIR$ ATTRIBUTES ALIGN : 64 ::  jn,jp,ids,ms,mw,isf,iwv,iwf,nvs,itmin
             !DIR$ ATTRIBUTES ALIGN : 64 ::  itmax,ia,iang,ik,jk,itau,itau0,jtau0
             !DIR$ ATTRIBUTES ALIGN : 64 ::  jtau,nang,nang2,nsmall,j
          ...
          type ArgsC16
              ...
              !DIR$ ATTRIBUTES ALIGN : 64 ::   A,B,cmz,Aj,Bj,A2,B2,Aj2,Bj2,A0,B0,ephi,ci,cin,ci0
              !DIR$ ATTRIBUTES ALIGN : 64 ::   A1,B1,Aj1,Bj1,Aj0,Bj0,cmzj,cmzg,Ag,Bg
          ...
          ! IT22 = ZERO          -|| -
           ...
           tr8%twopi  = 4.d0*pih
           tr8%pione  = 2.d0*pih
           tc16%ci=dcmplx(0._R64P,1._R64P)
           tc16%cin=dcmplx(0._R64P,-1._R64P)
           tc16%ci0=dcmplx(0._R64P,0._R64P)
           tr8%gcs=0._R64P
           tr8%gcv=0._R64P
           tr8%eps=1.0E-20_R64P
           tr8%fint=0._R64P
...
!C-----------------------------------------------------------------------  
      if(sang.lt.0.001_R64P) sang=90._R64P
         ti4%nang=90._R64P/sang+1._R64P
         ti4%nang2=2*ti4%nang-1
      if(ti4%nang2.gt.nangmax) then
...
!C-----------------------------------------------------------------------
    ...
    ! +                             (r0(j,i),j=1,9)
           if(idshp(ti4%i).eq.0) then
              do ti4%j=1,3
                  shp(ti4%j,ti4%i)=0._R64P
              enddo
         endif
         tr8%temp=dabs(shp(1,ti4%i)-1._R64P)
         tr8%temp0=0.0000001_R64P
         if(idshp(ti4%i).eq.-1.and.tr8%temp.lt.tr8%temp0) then
            idshp(ti4%i)=0
            do ti4%j=1,3
               shp(ti4%j,ti4%i)=0._R64P
            enddo
         ...
         r00(2,ti4%i)=y0
         r00(3,ti4%i)=z0
         r0(6,ti4%i)=dabs(r0(6,ti4%i))
         r0(9,ti4%i)=dabs(r0(9,ti4%i))
         ref(ti4%i)=dcmplx(r0(5,ti4%i),r0(6,ti4%i))
         refc(ti4%i)=dcmplx(r0(8,ti4%i),r0(9,ti4%i)) 
         tr8%gcs=tr8%gcs+r0(4,ti4%i)*r0(4,ti4%i)
         tr8%gcv=tr8%gcv+r0(4,ti4%i)*r0(4,ti4%i)*r0(4,ti4%i)
1        continue
         !close(2)
         tr8%gcsr=dsqrt(tr8%gcs)
         tr8%gcvr=tr8%gcv**(1.d0/3.d0)
         goto 11
 !10   write(6,*) 'fatal error in the input file'
 !     stop
 11      ti4%k=tr8%twopi/w
         tr8%xv=ti4%k*tr8%gcvr
         tr8%xs=ti4%k*tr8%gcsr
         if(irat.eq.1) then 
             write(6,'(a,f7.3)') ' volume-equiv. xv:  ', tr8%xv
         else 
             write(6,'(a,f7.3)') ' surface-equiv. xs: ', tr8%xs
         endif
       !  write(6,'(/)')
    !  fileout='gmm03Trd.out'
     ! fileout1=fileout
      ...
      do ti4%i=1,nL
         x(ti4%i)=ti4%k*r0(4,ti4%i)
         if(r0(7,ti4%i).lt.0.000000000001_R64P) then
            xc(ti4%i)=0._R64P
            refc(ti4%i)=dcmplx(0._R64P,0._R64P)
         else
            xc(ti4%i)=k*r0(7,ti4%i)
         endif
      enddo
!      C ----------------------------------------------------------------------
...
!C ----------------------------------------------------------------------
      ...
      do ti4%i=1,nL
         do ti4%j1=1,nmp
            do ti4%j2=1,nmp
               tbar(ti4%i,1,1,ti4%j1,ti4%j2)=0._R64P
               tbar(ti4%i,1,2,ti4%j1,ti4%j2)=0._R64P
               tbar(ti4%i,2,1,ti4%j1,ti4%j2)=0._R64P
               tbar(ti4%i,2,2,ti4%j1,ti4%j2)=0._R64P
            enddo
         enddo
         if(ti4%i.eq.1) goto  12
         do 121 ti4%j=ti4%i-1,1,-1
            if(idshp(ti4%i).eq.idshp(ti4%j).and.shp(1,ti4%i).eq.shp(1,ti4%j)) then
               if(xc(ti4%i).eq.xc(ti4%j).and.refc(ti4%i).eq.refc(ti4%j)) then
                  if(x(ti4%i).eq.x(ti4%j).and.ref(ti4%i).eq.ref(ti4%j)) then
                     nmax(ti4%i)=nmax(ti4%j)
                     uvmax(ti4%i)=uvmax(ti4%j)
                     do ti4%n=1,nmax(ti4%j)
                        do v=1,nmax(ti4%j)
			               in0=ti4%n*(ti4%n+1)
			               iv0=v*(v+1)
